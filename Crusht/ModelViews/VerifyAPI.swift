...
struct VerifyAPI {
    ...
    static let apiKey = "xiSHxI4fKEPYvtkhr2ZukF7qUBw5KNbX"
    ...
    static func validateVerificationCode(_ countryCode: String, _ phoneNumber: String, _ code: String, completion: @escaping (CheckResult) -> Void) {
