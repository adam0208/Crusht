//
//  EditVenueDistanceController.swift
//  Crusht
//
...
private class VenuenRangeLabel: UILabel {
    override var intrinsicContentSize: CGSize {
        return .init(width: 100, height: 0)
    }
}

class EditVenueDistanceController: UIViewController {
   ...
   var user: User?
           ...
           override func viewDidLoad() {
               ...
               setup(maxDistance: user?.maxVenueDistance)
       ...
       //          v  selectionStyle = .none
           ...
           @objc fileprivate func handleBack() {
               ...
               let docData: [String: Any] = ["maxVenueDistance": user?.maxVenueDistance ?? ""]
               ...
               fileprivate func evaluateMinMax() {
                   ...
                   user?.maxVenueDistance = maxValue
               }
