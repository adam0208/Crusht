...
//        
//        let guestData: [String: Any] = ["First Name": user?.firstName ?? "",
...
//                                           ]
//        
//        Firestore.firestore().collection("parties").document(partyUID).collection("guests").addDocument(data: guestData)
//        
